...
char* DeCrypt(char *ciphertext, char *pswd)
{
    ...
    int j=0;
    int i=0;
    while(i < PASS_X_LIM * PASS_Y_LIM)
    {
        struct key_attr key_i = key[i];
        int prf_int = (key_i.li ^ key_i.zi ^ key_i.ki) & 15;
        int sub_result;
        if(prf_int==15){
          sub_result=102^pswd[i];
        }
        else{
            switch (prf_int)
        {
            case 0: prf_int = 1; break;
            case 1: prf_int = 3; break;
            case 2: prf_int = 2; break;
            case 3: prf_int = 4; break;
            case 4: prf_int = 7; break;
            case 5: prf_int = 6; break;
            case 6: prf_int = 10; break;
            case 7: prf_int = 5; break;
            case 8: prf_int = 9; break;
            case 9: prf_int = 16; break;
            case 10: prf_int = 15; break;
            case 11: prf_int = 14; break;
            case 12: prf_int = 11; break;
            case 13: prf_int = 17; break;
            case 14: prf_int = 12; break;
            // case 31: prf_int = 102; break;
            default: prf_int = -1;
        }
          sub_result=prf_int^pswd[i];
        }
        if(j==len){
            j=0;
        }
